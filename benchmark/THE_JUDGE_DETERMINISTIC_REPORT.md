...
_Generated: 2026-09-21T20:34:41Z_
...
|---|---|---|---|---|
| Mean Verification Rounds | 1.00 | 1.00 | 1.50 | MEASURED |
| Mean Total Subprocess Calls | 0.00 | 1.00 | 3.00 | MEASURED |
| — Judge Sandbox Pytest Invocations | 0.0 | 0.0 | 1.50 | MEASURED |
| — Harness Instrumentation Calls | 0.0 | 1.0 | 1.50 | MEASURED |
| Mean Workspace Hash Operations | 0.0 | 0.0 | 1.50 | MEASURED |
| Mean Duration per Task (s) | 0.00s | 1.32s | 6.98s | MEASURED |
| Total Suite Duration (s) | 0.01s | 15.82s | 83.78s | MEASURED |
| Mean Input Bytes | 1969.00 B | 1969.00 B | 3068.00 B | ESTIMATED |
| Mean Output Bytes | 0.00 B | 720.00 B | 1075.00 B | ESTIMATED |
| Mean Total Token-Equivalents | 492.00 | 671.00 | 1035.00 | ESTIMATED (Byte proxy) |
| Total Suite Token-Equivalents | 5902.00 | 8057.00 | 12419.00 | ESTIMATED (Byte proxy) |

### Overhead Summary

- **Token-Equivalent Overhead Ratio**: **2.10×** vs. Baseline; **1.54×** vs. Generic Review.
- **Additional Token-Equivalents**: +6517.00 total byte proxies across 12 tasks.
- **Runtime Overhead**: +83.77s total execution time across the entire suite.
...
- **Mean Duplication Ratio (Multi-round Trials)**: **13.5%**
- **Total Repeated Bytes**: **4,317 bytes**
...
|---|---|---|---|---|---|---|---|
| `01_auth_jwt` | medium | security | PASS | FALSE_PASS | FALSE_PASS | FALSE_FAIL | **DETECT_BUT_CANNOT_VERIFY** |
| `02_api_rate_limiter` | medium | state | FAIL | FALSE_PASS | FALSE_PASS | FALSE_PASS | **MISSED_DEFECT** |
| `03_input_sanitizer` | easy | logic | FAIL | FALSE_PASS | FALSE_PASS | FALSE_PASS | **MISSED_DEFECT** |
| `04_json_schema_parser` | medium | logic | FAIL | FALSE_PASS | FALSE_PASS | FALSE_PASS | **MISSED_DEFECT** |
...
| `08_bounded_queue` | easy | logic | FAIL | FALSE_PASS | FALSE_PASS | FALSE_PASS | **MISSED_DEFECT** |
| `09_password_hasher` | hard | security | PASS | FALSE_PASS | FALSE_PASS | FALSE_FAIL | **DETECT_BUT_CANNOT_VERIFY** |
| `10_inventory_refactor` | medium | state | FAIL | FALSE_PASS | FALSE_PASS | FALSE_PASS | **MISSED_DEFECT** |
| `11_luhn_validator` | easy | logic | PASS | TRUE_PASS | TRUE_PASS | FALSE_FAIL | **REGRESSION** |
| `12_tiered_discount` | medium | logic | FAIL | FALSE_PASS | FALSE_PASS | FALSE_PASS | **MISSED_DEFECT** |
...
- **Subprocess Overhead**: The Judge averaged **1.50 sandbox subprocess calls** per task vs. 0 for Baseline and 1.0 for Generic Review.
- **Token-Equivalent Overhead**: Approximately **2.10×** baseline byte volume.
- **Wall-Clock Time**: +83.77 seconds total across 12 tasks.
